...
/* BLE Settings */
#define DEFAULT_BLUETOOTH_SPEED 9600 // The default baudrate
#define BLUETOOTH_SPEED 230400 // The baudrate you want to change
/*
...
//    Serial.println(c);
    ...
    /* Recieved "End" signal */
    else if ((char)c == 'E') setControllerStates(bytes);
